...
class View:
    ...
    def is_valid_alpha(self, input_string):
        """
        Vérifie si la chaîne de caractères fournie contient uniquement des
        caractères alphabétiques (et des espaces).
    ...
    def get_valid_date_input(self, prompt):
        """
        Demande à l'utilisateur d'entrer une date au format JJ/MM/AAAA jusqu'à
